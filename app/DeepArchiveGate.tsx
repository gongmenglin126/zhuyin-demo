...
export default function DeepArchiveGate({onCopyMaterial,hasMaterial}:{onCopyMaterial:(m:SharedMaterial)=>void;hasMaterial:(id:string)=>boolean}){
 ...
 return <section style={{marginTop:28,border:"1px solid #d7cec1",borderRadius:10,background:"#f6f2eb",overflow:"hidden"}}>
  <header style={{display:"flex",alignItems:"center",gap:10,padding:"14px 16px",borderBottom:"1px solid #ddd4c8",background:"#eee7dc"}}><FileArchive size={18}/><span><b style={{display:"block"}}>本地附件：archive_0712.zip</b><small style={{color:"#837a71"}}>加密压缩包 · 本地文件</small></span></header>
