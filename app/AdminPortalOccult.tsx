...
function ShenRecord({openDetail,onCopyMaterial,hasMaterial}:{openDetail:(x:AdminDetail)=>void;onCopyMaterial?:(m:SharedMaterial)=>void;hasMaterial?:(id:string)=>boolean}){return <article style={s.userRecord}>
 ...
 <section style={s.adminPanel}><h4>关联信息</h4><Record date="旧案" title="2004-07-17" meta="年龄 9 · 失踪 13 天" text="关联旧案：LN-2004-0718；关联对象：林楠。"/><Record date="2021-06-14" title="归巢命中" meta="外部检索 → 旧档主题" text="首次由外部检索进入走失后记忆异常相关旧帖；同类主题持续访问后，论坛账号转入长期观察。"/></section>
 ...
 <section style={s.adminPanel}><h4>执行信息</h4><Record date="HN-1016-02" title="对象类型：旧对契异常端" meta="执行批次" text="执行条件：待复核；当前场地字段未展开。"/></section>
 </article>}
