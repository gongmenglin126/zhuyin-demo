...
const dreamPost:Post={
 ...
 replies:[
  ...
  reply("一格胶片","09:12","这种老单位房我拍过不少，我帖子里有一组旧家属区的照片，你可以看看像不像。"),
...
const scriptureComparePost:Post={
  ...
  terms:["三门疏","黑底红字","白纸抄本","残页","旧短偈","再舍者","故门有声"],
...
const facelessIdolPost:Post={
  ...
  images:[{src:"assets/occult/factory-faceless-idol.jpg",caption:"附件：IMG_20240511_1937.jpg · 4栋后侧杂物间门口"}],
  replies:[
...
const deepMemoryPrivate:PrivateEntry={
